...
export const images = {
  ...
  projects: {
    aljazeraResidency: q('/photo-1545324418-cc1a3fa10c00'),
    speakersResidence: q('/photo-1512917774080-9991f1c4c750'),
    takbirThika: q('/photo-1558618666-fcd25c85cd64'),
    takbirMandera: q('/photo-1611974789855-9c2a0a7236a3'),
    housingStudy: q('/photo-1449824913935-59a10b8d2000'),
    residentialGeneric: q('/photo-1510627489930-0c1b0bfb6785'),
    commercialGeneric: q('/photo-1486325212027-8081e485255e'),
  },
  africa: {
  ...
  services: {
    ...
    supervision: q('/photo-1504307651254-35680f356dfd', 1920),
  },
  about: {
    office: q('/photo-1497366216548-37526070297c'),
    teamPhoto: q('/photo-1522071820081-009f0129c71c'),
    nairobi: q('/photo-1611348524140-53c9a25263d6'),
